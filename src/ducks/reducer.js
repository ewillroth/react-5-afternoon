...
export const updateAddLineOne = (addressOne) => {
	return {
		type: UPDATE_ADDRESS_ONE,
		payload: addressOne
	}
}
export const updateAddLineTwo = (addressTwo) => {
	return {
		type: UPDATE_ADDRESS_TWO,
		payload: addressTwo
	}
}
export const updateAddLineThree = (addressThree) => {
	return {
		type: UPDATE_ADDRESS_THREE,
		payload: addressThree
	}
}
export const updateFirst = (firstName) => {
	return {
		type: UPDATE_FIRST,
		payload: firstName
	}
}
export const updateLast = (lastName) => {
	return {
		type: UPDATE_LAST,
		payload: lastName
	}
